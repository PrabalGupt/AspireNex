...
/**
 * Generates the email body based on product information and notification type.
 * @param {Object} product - Product information object.
 * @param {string} product.title - Title of the product.
 * @param {string} product.url - URL of the product.
...
/**
 * Sends an email with the specified content to the given recipients.
